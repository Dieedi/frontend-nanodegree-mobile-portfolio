...
var resizePizzas = function(size) {
  ...
  var randPizCont = document.getElementsByClassName("randomPizzaContainer");
  var randPizContLenght = randPizCont.length;

  // Get offsetWidth of the page (document) to change pizza size depending on it
  var windowWidth = document.querySelector("#randomPizzas").offsetWidth;

  /*
   *  Get slider value and change pizza sizes
   *  For each case, change text value and loop trough each pizza to resize it
   */
  switch(size) {
        case "1":
          document.querySelector("#pizzaSize").innerHTML = "Small";
          for (var i = 0; i < randPizContLenght; i++) {
            randPizCont[i].style.width = windowWidth * 0.25 + "px";
        };
        break;
        case "2":
          document.querySelector("#pizzaSize").innerHTML = "Medium";
          for (var i = 0; i < randPizContLenght; i++) {
            randPizCont[i].style.width = windowWidth * 0.33 + "px";
        };
        break;
        case "3":
          document.querySelector("#pizzaSize").innerHTML = "Large";
          for (var i = 0; i < randPizContLenght; i++) {
            randPizCont[i].style.width = windowWidth * 0.5 + "px";
        };
        break;
        default:
...
function updatePositions() {
  ...
  // calculate scrolltop / 1250 out of for loop avoid too many calculations
  // scrolltop didn't change during for loop
